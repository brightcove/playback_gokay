...
```sh
git clone https://github.com/brightcove/playback_gokay
cd playback_gokay
go mod download
go install ./...
```
...
[This library builds on Jenkins, here.](https://jenkins.ci.brightcove.com/job/playback/job/gokay/job/test-only/)
